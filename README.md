[![Build Status](https://dev.azure.com/grahamhindle/Playground/_apis/build/status/grahamhindle.python-sample-vscode-flask-tutorial?branchName=master)](https://dev.azure.com/grahamhindle/Playground/_build/latest?definitionId=19&branchName=master)
